...
export const storyPages: StoryPage[] = [
  ...
  },
  {
    ...
    tone: "secret",
    lines: [
      "可是有一天，小杨在树林里看到一个“奇怪”的景象。",
      "他看到莉莉悄悄地把一件东西藏在了树洞里，还对着路过的“长耳朵兔子”小声说了些什么。",
      "当小杨走过去问她时，莉莉闪烁着大眼睛，红着脸说：“没什么呀，只是一个普通的小秘密。”",
    ],
    image: "/art/page-03.png",
  ...
  },
  {
    ...
    lines: [
      ...
      "小杨觉得心口酸酸的，像吃了一颗没熟透的青柠檬。",
      "那个“很好很好”的小杨，第一次变得笨笨的，他开始躲避莉莉，把自己关进了一个灰色的小房子里。",
    ],
    image: "/art/page-04.png",
  ...
  },
  {
    ...
    lines: [
      "门慢慢开了。",
      "莉莉拉起小杨的手，回到了那个树洞前。",
      "“对不起，小杨。我确实说了谎，因为我想在你的生日那天，送你一张完整的‘森林拼图’。”",
      "莉莉从树洞里拿出一块块发光的碎片，“我一直在偷偷收集你最喜欢的星光，想给你一个惊喜。我怕提前说了，惊喜就飞走了。”",
    ],
    image: "/art/page-06.png",
  ...
  },
  {
    ...
    tone: "blush",
    lines: [
      "原来，那些小杨以为的“欺骗”，其实是藏得太深的“浪漫”。",
      "小杨看着那些星光，觉得自己的脸比莉莉的红豆眼还要红。",
      "他小声说：“对不起，我只看到了那个‘谎言’，却忘记了你是一个多么好的人。我不该乱猜，我应该直接问你的。”",
    ],
    image: "/art/page-07.png",
  ...
  },
  {
    ...
    tone: "trust",
    lines: [
      "莉莉拉住小杨的手说：“没关系。虽然我们都是很好很好的人，但我们也会有‘笨拙’的时候。以后，如果我们心里有了小乌云，就一起把它们说出来，好吗？”",
      "小杨用力地点了点头。",
      "他们一起坐在树下，把那块关于“信任”的拼图，拼在了最中间。",
    ],
    image: "/art/page-08.png",
  ...
  },
  {
    ...
    lines: [
      ...
      "雾就会散去，阳光会重新照在两个“很好很好”的人身上。",
    ],
    image: "/art/page-09.png",
